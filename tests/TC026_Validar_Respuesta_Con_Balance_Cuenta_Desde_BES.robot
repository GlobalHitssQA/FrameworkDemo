...
*** Variables ***
# Datos de prueba - Número telefónico válido con cuenta activa en BES
${NUMERO_TELEFONICO_VALIDO}    5512345678

*** Test Cases ***
Validar Respuesta Con Balance De Cuenta Desde BES
    [Documentation]    Este caso de prueba verifica que la API ArService.QueryBalance de BES devuelve
    ...                correctamente la información de balance de la cuenta del cliente incluyendo el tipo
    ...                de balance y el monto asociado, asegurando que corresponda al cliente consultado.
    ...
    ...                Flujo de validación:
    ...
    ...                - balancetype: Tipo de balance de la cuenta (Prepago, Pospago, Híbrido, Crédito, Débito)
    ...                - ARBalance: Monto del balance de la cuenta (valor numérico)
    ...
    # THEN: Los valores retornados corresponden al cliente consultado mediante verificación cruzada con CustID
