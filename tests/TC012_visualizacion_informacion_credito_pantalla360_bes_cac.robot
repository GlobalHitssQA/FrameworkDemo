...
*** Test Cases ***
Verificar visualización de información completa del crédito en pantalla 360 de BES desde canal CAC
    [Tags]    PruebaGeneradaIA    Consulta    BES    Pantalla360    CAC    Funcional
    [Documentation]    Verificar que los usuarios del canal CAC puedan visualizar la información completa del crédito
    ...
    ...                Preconditions: Usuario CAC autenticado en BES; Cliente con crédito activo de Amigo Paguitos
    ...                existente en el sistema; Integración entre BES y canales CAC habilitada
    Given el usuario CAC está autenticado en BES y accede a la pantalla 360
    When se busca un cliente con crédito activo utilizando número de teléfono
...
*** Keywords ***
El usuario CAC está autenticado en BES y accede a la pantalla 360
    El usuario del canal CAC ingresa al sistema BES con credenciales válidas

Se busca un cliente con crédito activo utilizando número de teléfono
...
Se muestran los datos del equipo financiado asociado al crédito
    Se verifican los datos del equipo financiado
...
Toda la información desplegada corresponde al crédito consultado
    Toda la información mostrada corresponde al crédito consultado
